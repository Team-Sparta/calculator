        ...
        while (true) {
            try {
                ...
                double num2 = getInput("두 번째 숫자를 입력하세요: ", input -> {
                    ...
                    } catch (BadInputException | ZeroDivisionError e) {
                        throw new RuntimeException(e); // Wrap into RuntimeException to bypass checked exception
                    }
                });
...
//              displayAllResult(sc, parser);
    ...
    private static <T> T getInput(String prompt, Function<String, T> parser) throws BadInputException, ZeroDivisionError {
